...
const core: MentalProcess = async ({ workingMemory }) => {
  ...
  if (invocationCount === 0){
    speak("Hey! It seems to be our first time speaking speaking with Bozo. Ask me any $Bozo/Bitcoin/Ordinals related question and I'll do my best to answer it. Users usually start by asking me 'How do I get started with Bozo?' My knowledgebase is open sourced and is continuously being added to- you can view & add to it here: https://github.com/kingbootoshi/chadbot-v2")
  }
